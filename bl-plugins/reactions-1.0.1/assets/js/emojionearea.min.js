...
window = "undefined" != typeof global
        ...
        function(a) {
          ...
          function m(b, d, e) {
            ...
            if (d) {
              ...
              do {
                var h = 1 == g ? "@" + d : d;
                c[b.id][h] && c[b.id][h].length &&
                    a.each(c[b.id][h],
                           function(
                               a, c) { return f = c.apply(b, e || []) !== !1 })
              } while (f && g--)
            }
            return f
          }
          function n(b, c, e, f) {
            f = f || function(b, c) { return a(c.currentTarget) },
            ...
            if (window.getSelection) {
              if (b = window.getSelection(), b.getRangeAt && b.rangeCount) {
                ...
                while (f = d.firstChild)
                  g = e.appendChild(f);
                c.insertNode(e),
                    g && (c = c.cloneRange(), c.setStartAfter(g),
                          c.collapse(!0), b.removeAllRanges(), b.addRange(c))
              }
            } else
          ...
          function v() {
            ...
            return c > 4
                       ? b.filters = {
                           ...
                           recent :
                               {icon : "clock3", title : "Recent", emoji : ""},
                           smileys_people : {
                             icon : "yum",
            ...
            if (b && b.filters) {
              ...
              a.each(b.filters, function(b, c) {
                return !s(c) || a.isEmptyObject(c)
                           ? void delete d[b]
                           : void a.each(c, function(a, c) { d[b][a] = c })
              }), b.filters = d
            }
            return a.extend({}, c, b)
          }
                 ...
                 y =
                     function(a, b) {
                       ...
                       c.setStart(b.startContainer, b.startOffset),
                           ...
                           b = window.getSelection(), b.removeAllRanges(),
                           b.addRange(c)
                     })
              : document.selection && document.body.createTextRange &&
                    (x = function(
                         a) { return document.selection.createRange() },
                     y =
                         function(a, b) {
                           var c = document.body.createTextRange();
                           c.moveToElementText(a),
                               c.setStart(b.startContanier, b.startOffset),
                               c.setEnd(b.endContainer, b.endOffset), c.select()
                         });
          var z;
          function A(a, b) {
          ...
          function D() {
            var a = this, b = a.editor[0].offsetWidth - a.editor[0].clientWidth,
                c = parseInt(a.button.css("marginRight"));
            c !== b && (a.button.css({marginRight : b}),
          ...
          function I(b, c) {
            ...
            if (!b.recent || b.recent !== d || c) {
              if (d.length) {
                ...
                e ||
                    (f = b.scrollArea.scrollTop(), c && b.recentCategory.show(),
                ...
                if (b.recentCategory.children(".emojibtn").remove(),
                    a(h).insertAfter(b.recentCategory.children(
                        ".emojionearea-category-title")),
                    b.recentCategory.children(".emojibtn")
                        .on("click",
                            function() {
                ...
                b.recentFilter.hasClass("active") &&
                    b.recentFilter.removeClass("active").next().addClass(
                        "active"),
                    b.recentCategory.hide(), b.recentFilter.hide();
              b.recent = d
            }
          }
          function J(a, b) {
            var c = H(), d = c.split("|"), e = d.indexOf(b);
            e !== -1 && d.splice(e, 1), d.unshift(b), d.length > 9 && d.pop(),
                localStorage.setItem("recent_emojis", d.join("|")), I(a)
          }
          function K() {
            var a = "test";
            try {
          ...
          function L(b, c, d) {
            ...
            if (a.each(
                ...
                u = t.find(F("filter")), u.eq(0).addClass("active"),
                L = z.find(F("category-block")), A = z.find(F("category")),
                b.recentFilter = u.filter('[data-filter="recent"]'),
                b.recentCategory = A.filter("[name=recent]"), b.scrollArea = M,
                d.container ? a(d.container).wrapInner(O) : O.insertAfter(c),
                d.hideSource && c.hide(), b.setText(c[g]()), c[g](b.getText()),
                D.apply(b), b.standalone && !b.getText().length) {
            ...
            n(b, z.find(".emojibtn"), {click : "emojibtn.click"}),
                ...
                n(b, i, {paste : "!paste"}, i),
                n(b, i, [ "focus", "blur" ],
                  function() { return !b.stayFocused && i }),
                n(b, r, {
            ...
            if (M.on("scroll",
                     function() {
                       if (!R && (E.call(b), M.is(":not(.skinnable)"))) {
                         ...
                         A.each(function(b, e) {
                           return !(a(e).offset().top - d >= 10) &&
                                  void (c = a(e))
                         });
                         var e =
                             u.filter('[data-filter="' + c.attr("name") + '"]');
                         e[0] && !e.is(".active") &&
                ...
                b.on("@filter.click",
                     function(a) {
                       ...
                       R = !0, c || (u.filter(".active").removeClass("active"),
                                     a.addClass("active"));
                       var d = A.filter('[name="' + a.data("filter") + '"]')
                                   .offset()
                                   .top,
                           e = M.scrollTop(), f = M.offset().top;
                       M.stop().animate({scrollTop : d + e - f - 2}, 200,
                                        "swing",
                                        function() { E.call(b), R = !1 })
                     })
                    .on("@picker.show",
                        function() { b.recentEmojis && I(b), E.call(b) })
                    .on("@tone.click",
                        function(a) {
                        ...
                        function(c, d) {
                          var e = function(d) {
                            ...
                            (h + i >= j || h > i) &&
                                ...
                                g.remove(), b.stayFocused = !1, D.apply(b),
                                            m(b, "paste", [ c, d, f ])
                          };
                          if (d.originalEvent.clipboardData) {
                            ...
                            return e(f),
                                   d.preventDefault ? d.preventDefault()
                                                    : d.stop(),
                                   d.returnValue = !1, d.stopPropagation(), !1
                          }
                          b.stayFocused = !0, q("<span>" + l + "</span>");
                          var g = x(c[0]), h = c.scrollTop(),
                    ...
                    .on("@!mousedown",
                        function(c, d) {
                          return a(d.target).hasClass("search")
                                     ? (b.stayFocused = !0,
                                        null === b.searchSel &&
                                            (b.searchSel = x(c[0])))
                    ...
                    .on("@source.change",
                        function() { b.setText(c[g]()), m("change") })
                    .on("@focus", function() { O.addClass("focused") })
                    .on("@blur",
                        function() {
                          ...
                          var a = b.editor.html();
                          b.content !== a
                              ? (b.content = a, m(b, "change", [ b.editor ]),
                        ...
                        .on("@search.keypress",
                            function(c) {
                              var e = r.find(".emojionearea-filter"),
                                  f = d.tones ? N.find("i.active").data("skin")
                                              : 0,
                                  g = b.search.val().replace(/ /g, "_").replace(
                                      /"/g, '\\"');
                              g && g.length
                                  ? (b.recentFilter.hasClass("active") &&
                                         b.recentFilter.removeClass("active")
                                             .next()
                                             .addClass("active"),
                                     b.recentCategory.hide(),
                                     b.recentFilter.hide(), L.each(function() {
                                       var b = function(a, b) {
                                         var c =
                                             a.find('.emojibtn[data-name*="' +
                                                    g + '"]');
                                         if (0 === c.length)
                                  ...
                                  : (I(b, !0),
                                     L.filter('[data-tone="' +
                                              ...
                                              '"]:not([name="recent"])')
                                         .show(),
                                     a(".emojibtn", L).show(), e.show(),
                                     E.call(b))
                            })
                        .on("@search.blur",
                            function() {
                              b.stayFocused = !1,
                              b.search.removeClass("focused"), b.trigger("blur")
                            }),
                d.shortcuts &&
                    b.on("@keydown",
                         function(a, c) {
                ...
                s(d.events) && !a.isEmptyObject(d.events) &&
                    a.each(d.events,
                           function(a, c) { b.on(a.replace(/_/g, "."), c) }),
                d.autocomplete) {
              var S = function() {
                var c = {
                ...
                var f = a.map(e.emojioneList, function(a, b) {
                  return d.autocompleteTones ? b
                                             : /_tone[12345]/.test(b) ? null : b
                });
                f.sort(),
                    i.textcomplete([ {
                                     id : j,
                                     ...
                                     replace : function(
                                         a) { return p(a, b.emojiTemplate) },
                                     cache : !0,
                                     index : 1
                                   } ],
                                   c),
                    d.textcomplete.placement &&
                        "static" == a(i.data("textComplete").option.appendTo)
                                        .css("position") &&
                        a(i.data("textComplete").option.appendTo)
            ...
            b.inline &&
                (O.addClass(F("inline", !0)),
                 b.on("@keydown",
                      function(a, b) { 13 == b.which && b.preventDefault() })),
                /firefox/i.test(navigator.userAgent) &&
                    document.execCommand("enableObjectResizing", !1, !1),
                b.isReady = !0, b.trigger("onLoad", i), b.trigger("ready", i)
          }
          var M = {
          ...
          function N(b) {
            ...
            if (b = w(b), !M.isLoading)
              if (!e || u(t(e)) < 2) {
                M.isLoading = !0;
                var d;
                d = u(c) > 5 ? M.defaultBase3 + "npm/emojione@" + c
                             : u(c) > 4 ? M.defaultBase3 + "emojione/" + c
                                        : M.defaultBase + "/" + c,
                a.ajax({
                  ...
                  success : function() {
                    ...
                    k > 4 ? (M.base = M.defaultBase3 + "emojione/assets/" + c,
                             d = M.base + "/sprites/emojione-sprite-" +
                                 e.emojiSize + ".css")
              ...
              a.each(a.isArray(e[0]) ? e[0] : [ e[0] ], function(d, f) {
                a(f).on(e[1], function() {
                  var d = i.call(arguments),
                      f = a.isFunction(e[2]) ? e[2].apply(b, [ c ].concat(d))
                                             : e[2];
                  f && m(b, c, [ f ].concat(d))
                })
              })
   ...
   O.prototype.off = function(b, d) {
     ...
     var a = this;
     return g(function() { a.editor.focus() }), a
   }, O.prototype.setText = function(a) {
     var b = this;
     return g(function() {
              b.editor.html(B(a, b)), b.content = b.editor.html(),
                                      m(b, "change", [ b.editor ]), D.apply(b)
            }),
            b
     ...
     return a._sh_timer && window.clearTimeout(a._sh_timer),
            ...
            a._sh_timer =
                window.setTimeout(function() { a.button.addClass("active") },
                                  50),
            m(a, "picker.show", [ a.picker ]), a
   }, O.prototype.hidePicker = function() {
     var a = this;
     return a._sh_timer && window.clearTimeout(a._sh_timer),
            a.button.removeClass("active"),
            a._sh_timer =
                window.setTimeout(function() { a.picker.addClass("hidden") },
                                  500),
            m(a, "picker.hide", [ a.picker ]), a
     ...
     return N(b), g(function() {
              c.each(function() {
                var b = a(this);
                return b.hasClass("emojionearea-text") ||
                           b.addClass("emojionearea-text")
                               .html(B(b.is("TEXTAREA") || b.is("INPUT")
                                           ? b.val()
                                           : b.text(),
                                       d)),
                       b
